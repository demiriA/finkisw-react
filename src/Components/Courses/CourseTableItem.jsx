                ...
                </td>
                {
                    this.props.role === "TEACHER_USER" ?
                        ...
                        <td width="16%">
                            ...
                            <Link to={"/courses/users/t/"+id} className="btn btn-sm btn-primary m-1">{lang.EDIT_TEACHERS}</Link>
                            <Link to={"/courses/users/s/"+id} className="btn btn-sm btn-primary m-1">{lang.EDIT_STUDENTS}</Link>
                        </td>
                        )
                }
            </tr>
